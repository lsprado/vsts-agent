...
namespace Microsoft.VisualStudio.Services.Agent.Worker.Build
{
    ...
    public abstract class GitSourceProvider : SourceProvider, ISourceProvider
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            _repositoryUrlWithCred = UriUtil.GetCredentialEmbeddedUrl(repositoryUrl, username, password);
            if (!string.IsNullOrEmpty(executionContext.Variables.Agent_ProxyUrl))
            {
                _proxyUrlWithCred = UriUtil.GetCredentialEmbeddedUrl(new Uri(executionContext.Variables.Agent_ProxyUrl), executionContext.Variables.Agent_ProxyUsername, executionContext.Variables.Agent_ProxyPassword);
            }
